import type { SeasonState, PilotArchetype, Brand, Track, CareerStats } from '../types';
...
export function createSeason(team: string, pilot: PilotArchetype, brand: Brand, rng: RNG, careerStats?: CareerStats): SeasonState {
  resetProgression();
  const playerRider = createPlayerRider(team, pilot, brand, careerStats);
