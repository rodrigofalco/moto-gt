...
import {
  ...
  WET_CRASH_MULT, MIXED_CRASH_MULT,
} from './constants';

export function crashProbability(risk: Risk, consistency: number, track: Track, weather?: Weather): number {
  ...
  else if (weather === 'mixed') p *= MIXED_CRASH_MULT;
